...
double yourFitnessFunctionRealValued::getLowerRangeBound( int dimension, std::vector<double> &variables )
{
	return( -1000 );
}
		
double yourFitnessFunctionRealValued::getUpperRangeBound( int dimension, std::vector<double> &variables )
{
	return( 1000 );
}
